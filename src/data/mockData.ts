...
export const mockStores: Store[] = [
  {
    ...
    logo: 'https://via.placeholder.com/100x100/3B82F6/FFFFFF?text=TechHub',
    banner: 'https://via.placeholder.com/800x300/1F2937/FFFFFF?text=TechHub+Thailand',
    rating: 4.8,
    totalReviews: 15420,
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/100x100/EC4899/FFFFFF?text=Fashion',
    banner: 'https://via.placeholder.com/800x300/EC4899/FFFFFF?text=Fashion+Forward',
    rating: 4.6,
    totalReviews: 8930,
    hasPhysicalStore: true,
  ...
  },
  {
    ...
    logo: 'https://via.placeholder.com/100x100/10B981/FFFFFF?text=Home',
    banner: 'https://via.placeholder.com/800x300/10B981/FFFFFF?text=Home+Living+Store',
    rating: 4.7,
    totalReviews: 12350,
...
export const mockCategories: Category[] = [
  ...
  },
  {
    ...
    icon: '🏠',
    image: 'https://via.placeholder.com/400x300/10B981/FFFFFF?text=Home+%26+Living',
    subcategories: [
...
export const mockProducts: Product[] = [
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1592899677977-9c10b588e3e5?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999',
      'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999',
      'https://images.unsplash.com/photo-1510557880182-3ee4f8559622?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999'
    ],
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999',
      'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999'
    ],
    category: 'electronics',
    subcategory: 'laptop',
    technicalSpecs: {
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999',
      'https://images.unsplash.com/photo-1503341504253-dff4815485f1?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999',
      'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999'
    ],
    category: 'fashion',
  ...
  },
  {
    ...
    images: [
      'https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999',
      'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=500&h=500&fit=crop&crop=center&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&v=999'
    ],
    category: 'electronics',
    subcategory: 'audio',
    technicalSpecs: {
...
export const mockBanners: Banner[] = [
  {
    ...
    image: 'https://via.placeholder.com/1200x400/8B5CF6/FFFFFF?text=Try+Products+with+AR',
  ...
  },
  {
    ...
    image: 'https://via.placeholder.com/1200x400/3B82F6/FFFFFF?text=Compare+Prices+from+All+Platforms',
...
export const mockReviews: Review[] = [
  {
    ...
    userId: 'user-1',
    userName: 'สมชาย ใจดี',
    userAvatar: 'https://via.placeholder.com/50x50/3B82F6/FFFFFF?text=SM',
    rating: 5,
    title: 'คุ้มค่ามาก!',
    content: 'iPhone 15 Pro Max ใช้ได้ดีมาก กล้องถ่ายรูปสวยมาก แบตเตอรี่ทนได้ทั้งวัน',
    images: ['https://via.placeholder.com/300x300/10B981/FFFFFF?text=Review+Photo'],
